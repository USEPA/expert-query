...
export const createQuery = `CREATE TABLE IF NOT EXISTS ${tableName}
  (
    ...
    usename VARCHAR(255),
    useircategory NUMERIC(38,0),
    usestateircategory NUMERIC(38,0),
    usesupport VARCHAR(1),
    parameterattainment VARCHAR(240) NOT NULL,
    parameterircategory NUMERIC(38,0),
    parameterstateircategory NUMERIC(38,0),
    cyclefirstlisted NUMERIC(4,0),
    associatedactiondisplayname VARCHAR(303) NOT NULL,
    associatedactionid VARCHAR(45) NOT NULL,
    associatedactionname VARCHAR(255) NOT NULL,
    associatedactiontype VARCHAR(50) NOT NULL,
...
export async function transform(data) {
  ...
  data.forEach((datum) => {
    rows.push({
      ...
      associatedactiondisplayname: `${datum.associatedactionid} - ${datum.associatedactionname}`,
