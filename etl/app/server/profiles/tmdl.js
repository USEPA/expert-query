...
export const createQuery = `CREATE TABLE IF NOT EXISTS ${tableName}
  (
    ...
    pollutantgroup VARCHAR(60) NOT NULL,
    sourcetype VARCHAR(40) NOT NULL,
    addressedparameter VARCHAR(240) NOT NULL,
    addressedparametergroup VARCHAR(60) NOT NULL,
...
export async function transform(data) {
  ...
  data.forEach((datum) => {
    rows.push({
      ...
      addressedparametergroup: datum.addressedparametergroup,
      ...
      pollutantgroup: datum.pollutantgroup,
      region: datum.region,
