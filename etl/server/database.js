...
import { logger as log } from './utilities/logger';
import * as create from './queries/create';
...
const owpubConfig = {
  user: process.env.OW_USERNAME,
  password: process.env.OW_PASSWORD,
  database: 'owpub',
  port: process.env.OW_PORT,
  host: process.env.OW_HOST,
};
const owpubPool = new Pool(owpubConfig);
