...
describe('Data Profile Sources', () => {
  ...
  it('Verify copy box text flavor 1', () => {
    cy.selectCopyBox(
      ...
      `${clientUrl}/attains/sources?`,
    );
    cy.selectCopyBox(
      'api-query-copy-box-container',
      `${serverUrl}/api/attains/sources?${columnsValue}&format=csv&api_key=<YOUR_API_KEY>`,
    );
    cy.selectCopyBox(
      'curl-copy-box-container',
      `curl -X POST --json ${JSON.stringify(
        `{"filters":{},"options":{"format":"csv"},${columnsValueCurl}}`,
      )} ${serverUrl}/api/attains/sources -H "X-Api-Key: <YOUR_API_KEY>"`,
    );
  });
  ...
  it('Verify copy box text flavor 2', () => {
    ...
    cy.selectCopyBox(
      'current-query-copy-box-container',
      `${clientUrl}/attains/sources?${queryValue}`,
    );
    cy.selectCopyBox(
      'api-query-copy-box-container',
      `${serverUrl}/api/attains/sources?${columnsValue}&${queryValue}&format=csv&api_key=<YOUR_API_KEY>`,
    );
    cy.selectCopyBox(
      'curl-copy-box-container',
      `curl -X POST --json ${JSON.stringify(
  ...
  it('Verify copy box text flavor 3', () => {
    ...
    cy.selectCopyBox(
      'api-query-copy-box-container',
      `${serverUrl}/api/attains/sources?${columnsValue}&${queryValue}&format=xlsx&api_key=<YOUR_API_KEY>`,
    );
    cy.selectCopyBox(
      'curl-copy-box-container',
      `curl -X POST --json ${JSON.stringify(
  ...
  it('Verify copy box text flavor 5', () => {
    ...
    cy.selectCopyBox(
      'api-query-copy-box-container',
      `${serverUrl}/api/attains/sources?${columnsValue}&${queryValue}&format=tsv&api_key=<YOUR_API_KEY>`,
    );
    cy.selectCopyBox(
      'curl-copy-box-container',
      `curl -X POST --json ${JSON.stringify(
